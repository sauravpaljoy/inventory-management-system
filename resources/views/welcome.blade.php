          ...
          <div class="cs-main_header_right">
            <div class="cs-toolbox">
              @guest
                ...
                <a href="{{ route('register') }}" class="cs-btn cs-color1"><span>Register</span></a>
              @else
    ...
    <section class="cs-hero cs-style1 cs-bg" data-src="{{ asset('assets/img/hero_bg.svg') }}">
      <div class="container">
        ...
        <div class="cs-hero_text">
          ...
          <a href="{{ route('register') }}" class="cs-btn"><span>Start Free Trial</span></a>
        </div>
          ...
          <div class="cs-pricing_table cs-style1">
            ...
            <div class="cs-pricing_body">
              ...
              <div class="cs-pricing_btn">
                <a href="{{ route('register') }}" class="cs-btn cs-size_md"><span>Buy Now</span></a>
              </div>
            </div>
          </div>
          <div class="cs-height_25 cs-height_lg_25"></div>
